let Journal;_76c‍.x([["createJournalEntry",()=>createJournalEntry],["updateJournalEntry",()=>updateJournalEntry],["deleteJournalEntry",()=>deleteJournalEntry],["getJournalEntry",()=>getJournalEntry],["getAllJournalEntries",()=>getAllJournalEntries]]);_76c‍.w("../models/Journal",[["default",["Journal"],function(v){Journal=v}]]);

const createJournalEntry = async (req, res, next) => {
  try {
    _76c‍.g.console.log(req.body)
...
const getJournalEntry = async (req, res, next) => {
  try {
    ...
    _76c‍.g.console.log(journalEntry)
